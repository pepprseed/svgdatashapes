...
def example7a():
    # essentially same code as example7 but with a log Y axis
    ...
    p.numspace( axis='Y', axmin=5, axmax=yrange.axmax, poslo=60, poshi=340, log=True )  
    ...
    p.axisrender( axis='y', tics=8, loc='min-8', grid=True, inc=5, stubcull=20 )   
