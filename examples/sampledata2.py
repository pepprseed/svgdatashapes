...
def vectors( setid ):
    ...
    if setid == 'set1': 
        return [ 33, 36, 39, 41, 41, 49, 53, 58, 61, 63, 65, 67, 69, 69, 71, 73, 76, 77, 78, 79, 82, 86, 87, 87, 88, 89, 
        ...
        return [ 35, 47, 51, 51, 52, 52, 56, 59, 62, 62, 62, 62, 64, 65, 67, 69, 72, 72, 73, 73, 75, 75, 76, 76, 79, 79, 
        ...
        return [ 9, 15, 27, 28, 36, 38, 40, 41, 44, 45, 45, 50, 52, 53, 53, 55, 56, 56, 59, 60, 60, 61, 62, 63, 63, 65, 70, 
        ...
        return [ 16, 21, 22, 25, 29, 32, 32, 33, 34, 42, 43, 44, 44, 44, 45, 45, 46, 46, 48, 48, 48, 49, 51, 53, 53, 56, 
